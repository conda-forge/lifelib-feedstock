...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lifelib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15256&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lifelib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lifelib` can be installed with:

```
conda install lifelib
```

It is possible to list all of the versions of `lifelib` available on your platform with:
